...
//check that there is data. if so, loops through the rows and grabs the forename and surname for each and prints it out for the user to see
if($rows->rowCount() > 0) {
  foreach($rows as $row) {
    ...
    if (isset($forename)){
      ...
      echo "There were no students interested in this event";
      //If there are no results, the print out message to user that no students were interested in that event
    }
  }
}
?>
